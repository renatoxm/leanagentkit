...
9. **## Learned notes** — _(generated/project skills only)_ append-only gotchas discovered in practice.
...
**Project-wide** avoidable mistakes (commitlint, hooks, repo conventions) belong in
`docs/memory/LEARNINGS.md` and may promote into `AGENTS.md` §4/§5 — see `AGENTS.md` §6.
